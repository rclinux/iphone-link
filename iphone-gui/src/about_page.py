...
ABOUT = (
    ...
    "Securely link your iPhone to this Linux system to share documents, photos "
    "and messages, and (with a companion app) sync notifications, clipboard and "
    "media playback. It is a thin wrapper: every operation runs the same audited "
    ...
    "• <b>Photos</b> — browses the camera roll (DCIM) over AFC and copies "
    "pictures and videos to a folder you choose.  <i>(coming next)</i>\n"
    "• <b>Documents</b> — lists apps that enable File Sharing and copies files "
    "in and out of their document folders.  <i>(coming next)</i>\n"
    "• <b>Messages</b> — exports your texts to readable text or CSV files from a "
    "device backup (reads <tt>sms.db</tt>, decoding modern attributed-body text).\n"
    "• <b>Notes</b> — exports Apple Notes to one text file per note (grouped by "
    "folder) or CSV, from the same backup (decodes the compressed note bodies).\n"
    "• <b>Media</b> — plays the iPhone's audio, video and screen on this PC over "
    "<b>AirPlay</b> (UxPlay receiver); start it here and pick this PC from Screen "
    "Mirroring on the iPhone.\n\n"
